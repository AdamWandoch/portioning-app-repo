...
public class Portioner {
    ...
    public void PrintStats() {
        ...
        System.out.println("Average graded portion size: " + String.format("%.5f", (gradedAmount / gradedCount)));
        System.out.println("Product yield: " + String.format("%.5f", (gradedAmount / totalFilletsWeight)));
        System.out.println("Target cuts percentage: " + String.format("%.5f", ((double) targetGradeCount) / ((double) gradedCount)));
        ...
        System.out.println("Mix percentage: " + String.format("%.5f", mixGradeAmount / totalFilletsWeight));
        System.out.println("Average mix grade size: " + String.format("%.5f", mixGradeAmount / mixGradeCount));
    ...
    // ******************* the difference between totalVolumeFromGrader and totalFillets weight************************ //
    // ******************* is in multiplies of target size; means that grade(target) called to many times************** //
